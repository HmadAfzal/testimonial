    ...
    <div className='flex bg-[#030816] h-screen w-screen justify-center items-center'>
        <div className='p-6 mx-4 border border-slate-700 rounded-xl bg-[#030816] '>
          ...
          <form action="" className='flex flex-col gap-2'>
            ...
            <Input id='email' type='email' placeholder='m@email.com' className='border text-white border-slate-500 bg-transparent my-1'/>
            </div>
            <div>
            <label htmlFor='name' className='text-white font-semibold'>name</label>
            <Input id='name' type='text' className='border text-white border-slate-500 bg-transparent my-1'/>
            <label htmlFor='password' className='text-white font-semibold'>Password</label>
            <Input id='password' type='password' className='border text-white border-slate-500 bg-transparent my-1'/>
            </div>
            <Button type="submit" className='my-2 bg-white text-[#030816] hover:bg-slate-300 font-semibold'>Create account</Button>
          </form>
          <p className='text-center mt-1 text-slate-400 text-sm font-medium'>Already have an account?<Link href={"/sign-in"} className='px-1 text-slate-200 font-semibold hover:underline'>Login !</Link></p>
        </div>
